...
REGISTERS: dict[str, RegisterDefinition] = {
    ...
    rn.CAPBANK_RUNNING_TIME: U32Register("hour", 10, 35000, 2),
    rn.INTERNAL_FAN_1_RUNNING_TIME: U32Register("hour", 10, 35002, 2),
    rn.INV_MODULE_A_TEMP: I16Register ("°C", 10, 35021,1),
    rn.INV_MODULE_B_TEMP: I16Register ("°C", 10, 35022,1),
    rn.INV_MODULE_C_TEMP: I16Register ("°C", 10, 35023,1),
    rn.ANTI_REVERSE_MODULE_1_TEMP: I16Register ("°C", 10, 35024,1),
    rn.OUTPUT_BOARD_RELAY_AMBIENT_TEMP_MAX: I16Register ("°C", 10, 35025,1),
    rn.ANTI_REVERSE_MODULE_2_TEMP: I16Register ("°C", 10, 35027,1),
    rn.DC_TERMINAL_1_2_MAX_TEMP: I16Register ("°C", 10, 35028,1),
    rn.AC_TERMINAL_1_2_3_MAX_TEMP: I16Register ("°C", 10, 35029,1),
    rn.PHASE_A_DC_COMPONENT_DCI: I16Register ("A", 1000, 35038,1),
    rn.PHASE_B_DC_COMPONENT_DCI: I16Register ("A", 1000, 35039,1),
    rn.PHASE_C_DC_COMPONENT_DCI: I16Register ("A", 1000, 35040,1),
    rn.LEAKAGE_CURRENT_RCD: I16Register ("mA", 1, 35041,1),
    rn.POSITIVE_BUS_VOLTAGE : I16Register ("V", 10, 35042,1),
    rn.NEGATIVE_BUS_VOLTAGE : I16Register ("V", 10, 35043,1),
    rn.BUS_NEGATIVE_VOLTAGE_TO_GROUND : I16Register ("V", 10, 35044,1),
