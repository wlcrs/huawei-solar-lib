...
SDONGLE_REGISTERS = {
    ...
    rn.SDONGLE_DEVICE_SEARCH_STATUS: U16Register(rv.SDongleDeviceSearchStatus, 1, 37411, target_device=TargetDevice.SDONGLE),
    ...
    rn.SDONGLE_WIRELESS_ROUTE_ACCESS_SIGNAL_STRENGTH : I16Register(rv.SDongleWirelessRouteAccessSignalStrength4G, 1, 35104, target_device=TargetDevice.SDONGLE),
    ...
    rn.SDONGLE_UNSOLICITED_REPORT_INTERVAL: U16Register("min", 1, 43134, target_device=TargetDevice.SDONGLE, writeable=True),
    rn.SDONGLE_REPORTED_DATA_RECORD_PERIOD: U16Register(bool, 1, 43311, target_device=TargetDevice.SDONGLE, writeable=True),
    rn.SDONGLE_NTP_TIME_SYNCHRONIZATION: U16Register("min", 1, 43343, target_device=TargetDevice.SDONGLE, writeable=True),
    rn.SDONGLE_CARD_NUMBER_4G: StringRegister(43386, 10, target_device=TargetDevice.SDONGLE, writeable=True),
    rn.SDONGLE_NETWORK_MODE_4G: U16Register(rv.SDongleNetworkMode4G, 1, 43430, target_device=TargetDevice.SDONGLE, writeable=True),
