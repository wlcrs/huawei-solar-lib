...
GRID_CODES = {
    ...
    29: GridCodes("Custom MV480 (50 Hz)", "Custom"),
    30: GridCodes("Custom MV480 (60 Hz)", "Custom"),
    31: GridCodes("G59-England-MV480", "UK"),
    32: GridCodes("IEC61727-MV480", "General"),
    33: GridCodes("UTE C 15-712-1-MV480", "France"),
    34: GridCodes("TAI-PEA-MV480", "Thailand"),
    35: GridCodes("TAI-MEA-MV480", "Thailand"),
    36: GridCodes("EN50438-DK-MV480", "Denmark"),
    37: GridCodes("Japan standard (50 Hz)", "Japan"),
    38: GridCodes("Japan standard (60 Hz)", "Japan"),
    39: GridCodes("EN50438-TR-MV480", "Turkey"),
    40: GridCodes("EN50438-TR", "Turkey"),
    41: GridCodes("C11/C10-MV480", "Belgium"),
    42: GridCodes("Philippines", "Philippines"),
    43: GridCodes("Philippines-MV480", "Philippines"),
    44: GridCodes("AS4777-MV480", "Australia"),
    45: GridCodes("NRS-097-2-1", "South Africa"),
    46: GridCodes("NRS-097-2-1-MV480", "South Africa"),
    47: GridCodes("KOREA", "South Korea"),
    48: GridCodes("IEEE 1547-MV480", "USA"),
    49: GridCodes("IEC61727-60Hz", "General"),
    50: GridCodes("IEC61727-60Hz-MV480", "General"),
}
