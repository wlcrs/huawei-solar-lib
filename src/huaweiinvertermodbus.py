...
ATTR_NB_PV_STRINGS = "nb_pv_string"
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        vol.Required(CONF_HOST, default="straat"): cv.string,
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    entities.append(HuaweiInverterSensor(inverter, name))

    add_entities(entities)


class HuaweiInverterSensor(Entity):
    def __init__(self, inverter, name):
        self._inverter = inverter
        self._model_name = self._inverter.get("model_name").value
        ...
        self._total_yield = self._inverter.get("daily_yield_energy").value
    ...
    def device_state_attributes(self):
        return {
            ...
            ATTR_NB_PV_STRINGS: self._nb_pv_string,
